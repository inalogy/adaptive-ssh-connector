...
public class Constants {
    ...
    public static final List<String> SimulationOperations = Collections.unmodifiableList(
            Arrays.asList(CREATE_OPERATION, UPDATE_OPERATION, DELETE_OPERATION)
    );
    ...
    public static final int SSH_RESPONSE_TIMEOUT = 200;
    /**
