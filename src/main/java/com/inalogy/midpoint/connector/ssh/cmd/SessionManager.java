...
public class SessionManager {
     ...
     */
    public String exec(String processedCommand, String operationName) {
        if (this.configuration.getSimulationExecution() && Constants.SimulationOperations.contains(operationName)){
            LOG.warn("[Simulated Execution] final command: {0}", processedCommand);
            return "";
        }

        LOG.ok("Executing Command: {0}", processedCommand);
        startSession();
