...
//    public static final String ARGUMENT_STYLE_DASHDASH = "dashdash";
    ...
    @ConfigurationProperty(order = 100,
            displayMessageKey = "SimulationExecution.display",
            helpMessageKey = "SimulationExecution.help"
    )
    public boolean getSimulationExecution() {return simulationExecution;}

    public void setSimulationExecution(boolean simulationExecution){this.simulationExecution = simulationExecution;}
