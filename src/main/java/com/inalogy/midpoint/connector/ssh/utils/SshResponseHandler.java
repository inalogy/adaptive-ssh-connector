    ...
    public Set<Map<String, String>> parseSearchOperation() {
        ...
        for (int i = 1; i < lines.length; i++) {
            ...
            try {
                ...
                if (this.dynamicConfiguration.getSettings().getSearchOperationSettings().getIgnoreInvalidResultObjects()){
                    LOG.error("FATAL: skipping invalid result row {0}", Arrays.toString(attributeValues));
                }
                else {
                    throw e;
                }
