...
import com.inalogy.midpoint.connector.ssh.cmd.CommandProcessor;
import com.inalogy.midpoint.connector.ssh.cmd.SessionManager;
import com.inalogy.midpoint.connector.ssh.filter.SshFilter;
import com.inalogy.midpoint.connector.ssh.filter.SshFilterTranslator;
import com.inalogy.midpoint.connector.ssh.objects.UniversalObjectsHandler;
...
import com.inalogy.midpoint.connector.ssh.utils.FileHashCalculator;
import com.inalogy.midpoint.connector.ssh.utils.dynamicconfig.DynamicConfiguration;
import com.inalogy.midpoint.connector.ssh.utils.SshResponseHandler;
        ...
        DeleteOp
{
    ...
    public void executeQuery(ObjectClass objectClass, SshFilter query, ResultsHandler handler, OperationOptions options) {
        ...
        LOG.ok("SearchOperation Execution Time: {0} ms", elapsedTimeMillis);
    }
